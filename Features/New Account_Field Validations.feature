...
@mytag
Scenario: "First Name" validation of Account Registration form with spaces
...
Scenario: "First Name" validation of Account Registration form with special characters
	Given User navigated to Account Registration form
	When User entered special characters in First Name
	Then error message should be displayed stating that Names must containg atleast one letter.

Scenario: "First Name" validation of Account Registration form with text containing special characters
	Given User navigated to Account Registration form
	When User entered text of special characters and numbers in First Name
	Then error message should be displayed stating that Names must containg atleast one letter.

Scenario: "First Name" validation of Account Registration form with blank
Given User navigated to Account Registration form
	When User entered blank in First Name
	Then error message should be displayed stating that First Name should not be blank.

Scenario: "Last Name" validation of Account Registration form with spaces
	Given User navigated to Account Registration form
	When User entered spaces in Last Name
	Then error message should be displayed stating that Names must containg atleast one letter.

Scenario: "Last Name" validation of Account Registration form with special characters
	Given User navigated to Account Registration form
	When User entered special characters in Last Name
	Then error message should be displayed stating that Names must containg atleast one letter.

Scenario: "Last Name" validation of Account Registration form with text containing special characters
	Given User navigated to Account Registration form
	When User entered text of special characters and numbers in Last Name
	Then error message should be displayed stating that Names must containg atleast one letter.

Scenario: "Last Name" validation of Account Registration form with blank
Given User navigated to Account Registration form
	When User entered blank in Last Name
	Then error message should be displayed stating that Last Name should not be blank.

Scenario: "Email address" validation of Account Registration form with spaces
	Given User navigated to Account Registration form
...
Scenario: "Email address" validation of Account Registration form with special characters
	Given User navigated to Account Registration form
...
Scenario: "Email address" validation of Account Registration form with blank
	Given User navigated to Account Registration form
...
Scenario: "Email address" validation of Account Registration form with registered id
	Given User navigated to Account Registration form
...
Scenario: "Password" validation of Account Registration form with blank
	Given User navigated to Account Registration form
	When User entered blank in Password
	Then error message should be displayed stating that password is invalid	

Scenario: "Confirm Password" validation of Account Registration form with blank
	Given User navigated to Account Registration form
	When User entered blank in Confirm Password
	Then error message should be displayed stating that password is invalid	

Scenario: Mismatch of "Password" and "Confirm Password" in Account Registration form 
	Given User navigated to Account Registration form
